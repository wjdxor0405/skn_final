...
> **기준: 2026-09-08.** 설계 도식은 [`docs/아키텍처.md`](docs/아키텍처.md), 화면 계약은
...
**2026-09-06 에 협상이 메인 테마에서 내려왔습니다** — 실제 협상은 재현이 어렵다는 평가였습니다.
그래도 지우지 않았습니다.
...
2026-09-06 에 CRM 폐기가 확정되면서 함께 내려왔습니다 — 기준값이 Odoo에 있었기
